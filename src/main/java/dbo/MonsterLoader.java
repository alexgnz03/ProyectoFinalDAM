...
public class MonsterLoader {
    ...
    public MonsterLoader() {
        try {
            ...
            if (!existe) {
                crearTablas();
                insertarRegistros(); // Si deseas insertar registros al crear la base de datos
            }
    ...
    public void insertarRegistros() {
        ...
        try {
            ...
            String insertEnemy1 = "INSERT INTO Enemy (Nombre, Descripcion, Registrado) VALUES ('Otaku', 'Le gusta ver anime y jugar a videojuegos. No sale de su casa (Como yo desde que empezó el segundo trimestre)', 0)";
            ...
            String insertEnemy6 = "INSERT INTO Enemy (Nombre, Descripcion, Registrado) VALUES ('Antonio', 'Antonio maquinote', 0)";
